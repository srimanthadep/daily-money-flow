    ...
    <div className="bg-[#F8FAFC] min-h-screen">
      <main className="container py-4 md:py-8 px-4 md:px-8 space-y-4 md:space-y-6 max-w-5xl animate-fade-in">
        ...
        <div className="print-only mb-6">
          <h1 className="text-2xl font-black text-slate-900">Entries List - {new Date(viewDate).toLocaleDateString('en-IN', { day: 'numeric', month: 'long', year: 'numeric' })}</h1>
        </div>


        {/* Date nav + Add button */}
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-6 sm:gap-3 no-print">
          <DateNavigator
            viewDate={viewDate}
